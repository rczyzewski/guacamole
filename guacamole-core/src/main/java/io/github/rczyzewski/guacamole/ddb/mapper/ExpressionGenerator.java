...
public class ExpressionGenerator<T> {
  ...
  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, Path<T> path2) {
  ...
  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, Double value) {
    return this.compare(path1, op, AttributeValue.fromN(Double.toString(value)));
  }

  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, Long value) {
    return this.compare(path1, op, AttributeValue.fromN(Long.toString(value)));
  }

  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, Float value) {
    return this.compare(path1, op, AttributeValue.fromN(Float.toString(value)));
  }

  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, Integer value) {
    return this.compare(path1, op, AttributeValue.fromN(Integer.toString(value)));
  }

  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, AttributeValue value) {
  ...
  public LogicalExpression<T> compare(
      Path<T> path1, LogicalExpression.ComparisonOperator op, String value) {
    return LogicalExpression.ComparisonToValue.<T>builder()
  ...
  public LogicalExpression<T> and(
      LogicalExpression<T> l1, LogicalExpression<T> l2, LogicalExpression<T> l3) {
