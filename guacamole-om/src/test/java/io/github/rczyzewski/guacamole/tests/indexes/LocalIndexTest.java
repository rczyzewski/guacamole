...
class LocalIndexTest {
    ...
    private final static String TABLE_NAME = "ForumThread";

    private final static ForumThreadRepository repo = new ForumThreadRepository(TABLE_NAME);
    ...
    @BeforeEach
    void beforeEach() {
        List<ForumThread> data = Arrays.asList(
                ForumThread.builder()
                        .forumName("S3")
                        .subject("aaa")
                        .replies(12)
