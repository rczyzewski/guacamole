...
public class DynamoDBProcessor extends AbstractProcessor {
  ...
  public JavaFile generateRepositoryCode(ClassDescription classDescription) {
    ClassName clazz = ClassName.get(Optional.ofNullable(classDescription.getPackageName()).orElse(""), classDescription.getName());
                        ...
                        it -> {
                          ...
                          return FieldSpec.builder(
                                  get(
                                      ...
                                      ClassName.get(Optional.ofNullable(it.getPackageName()).orElse(""), it.getName())),
    ...
    return JavaFile.builder(Optional.ofNullable(classDescription.getPackageName()).orElse(""), navigatorClass.build())
